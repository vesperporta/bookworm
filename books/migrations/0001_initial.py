    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ean', models.CharField(blank=True, db_index=True, max_length=13, null=True, unique=True, verbose_name='International Article Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(choices=[(0, 'Unrated'), (1, 'Terrible and Trashy'), (2, 'Junk Pile'), (3, 'Readable'), (4, 'Good Read'), (5, "Couldn't Put Down")], default=0)),
                ...
                ('post', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='book_review+', to='posts.Post', verbose_name='Post')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentication.Profile')),
                ('progress', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reviewed_at', to='books.BookProgress', verbose_name='Progress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_true', models.NullBooleanField(default=None, verbose_name='Boolean Answer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multi_choice_answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='multi_choice', to='books.ConfirmReadQuestion', verbose_name='Answer')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentication.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(blank=True, related_name='_readinglist_images_+', to='file_store.Image', verbose_name='Images')),
