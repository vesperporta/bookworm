    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copy', models.CharField(max_length=200, verbose_name='Answer Copy')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentication.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='read', to='books.Book', verbose_name='Book')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentication.Profile')),
                ('question', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='read', to='books.ConfirmReadQuestion', verbose_name='Question Challenge')),
                ('review', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='read', to='books.BookReview', verbose_name='Review')),
            ],
            options={
                'verbose_name': 'Read',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('id', hashid_field.field.HashidAutoField(alphabet='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', min_length=7, primary_key=True, serialize=False)),
                ('book', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='thrills', to='books.Book', verbose_name='Book')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='authentication.Profile')),
                ('reading_list', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='thrills', to='books.ReadingList', verbose_name='Reading List')),
            ],
            options={
                'verbose_name': 'Thrill',
