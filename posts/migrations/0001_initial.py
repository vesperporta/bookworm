    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.ManyToManyField(blank=True, related_name='_post_images_+', to='file_store.Image', verbose_name='Images')),
                ('localisations', models.ManyToManyField(blank=True, related_name='_post_localisations_+', to='meta_info.LocaliseTag', verbose_name='Localisation')),
